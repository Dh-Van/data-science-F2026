...
df_q3 <- 
  flights %>% 
  filter(
    near(arr_time, sched_arr_time, 10)
  )
...
**Observations** - Was this dataset assembled to study flights *out of* NYC, or *into* NYC? How do you know? - out of NYC, since all the origin ariports are airports in NYC but the dest airports are not in NYC
