...
ideal cuts, which disproves the hypothesis
...
**Observations**: - Write your observations here! Maybe there are more
ideal cuts that are pricer, but all the cuts go up to the max price
...
**Observations**: - Write your observations here! Contradicts because
the mean price of the ideal cuts is the lowest, and even the upper
quartle is the lowest
...
**Observations**: - Write your observations here! Yes the better the cut
is, the lower the carats tend to be
