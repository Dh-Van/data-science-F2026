...
- This is a plot of the Price vs. Carat of Diamonds. From just looking at the graph, it seems like the price of a diamond is positively correlated to the carat weight of the diamond. This correlation is much stronger when we look at diamonds under 1 carat. Once we are above 1 carat, and especially once we are above around 2.5 carats, it seems as if there is some confounding variable that is impacting the price of the diamond. For example, at \~3 carats we can see the price of the diamond can range anywhere from \~\$6000 all the way to \~\$18000. We can also see cases of diamonds above 4 carats that happen to be cheaper than diamonds that are under 2 carats.
...
- This is a graph of price v carat v cut of Diamonds. From just looking at the graph, we can once again tell that the price of a diamond and the carat weight of a diamond are generally positively correlated especially under 1 carat. From the new information given by the cut of the diamond, we get some additional information into what might be the confounding variable. Taking the example I used above, of the \~3 carat diamonds, we can see that most of the diamonds above \$12,500 range between Very Good and Ideal, whereas most of the diamonds below \$12,500 range between Good and Fair. This isn’t without nuance, since some diamonds below that price point are a Premium cut, and some diamonds above that price point are only a Good cut. This points to the existence of yet another confounding variable. Another observation is that 4 out of the 5 diamonds above 4 carats all are pretty poor cuts, only ranging from Very Good to Fair and some lower carat diamonds (between 1 and 2 carats) that are an Ideal cut are just as, if not more expensive that the 4-5 carat diamonds. Both of these cases show that the cut of a diamond plays a pretty important role in the price, alongside the carat weight.
